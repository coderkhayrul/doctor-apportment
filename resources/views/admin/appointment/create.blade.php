                ...
                <table class="table table-striped">
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <div class="border-checkbox-group border-checkbox-group-primary">
                                    <input class="border-checkbox" type="checkbox" name="time[]" id="time[]" value="12pm">
                            ...
                            <td>
                                <div class="border-checkbox-group border-checkbox-group-primary">
                                    <input class="border-checkbox" type="checkbox" name="time[]" id="time[]" value="12.20pm">
                            ...
                            <td>
                                <div class="border-checkbox-group border-checkbox-group-primary">
                                    <input class="border-checkbox" type="checkbox" name="time[]" id="time[]" value="12.40pm">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="border-checkbox-group border-checkbox-group-primary">
                                    <input class="border-checkbox" type="checkbox" name="time[]" id="time[]" value="1pm">
                            ...
                            <td>
                                <div class="border-checkbox-group border-checkbox-group-primary">
                                    <input class="border-checkbox" type="checkbox" name="time[]" id="time[]" value="1.20pm">
                            ...
                            <td>
                                <div class="border-checkbox-group border-checkbox-group-primary">
                                    <input class="border-checkbox" type="checkbox" name="time[]" id="time[]" value="1.40pm">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="border-checkbox-group border-checkbox-group-primary">
                                    <input class="border-checkbox" type="checkbox" name="time[]" id="time[]" value="2pm">
                            ...
                            <td>
                                <div class="border-checkbox-group border-checkbox-group-primary">
                                    <input class="border-checkbox" type="checkbox" name="time[]" id="time[]" value="2.20pm">
                            ...
                            <td>
                                <div class="border-checkbox-group border-checkbox-group-primary">
                                    <input class="border-checkbox" type="checkbox" name="time[]" id="time[]" value="2.40pm">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="border-checkbox-group border-checkbox-group-primary">
                                    <input class="border-checkbox" type="checkbox" name="time[]" id="time[]" value="3pm">
                            ...
                            <td>
                                <div class="border-checkbox-group border-checkbox-group-primary">
                                    <input class="border-checkbox" type="checkbox" name="time[]" id="time[]" value="3.20pm">
                            ...
                            <td>
                                <div class="border-checkbox-group border-checkbox-group-primary">
                                    <input class="border-checkbox" type="checkbox" name="time[]" id="time[]" value="3.40pm">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="border-checkbox-group border-checkbox-group-primary">
                                    <input class="border-checkbox" type="checkbox" name="time[]" id="time[]" value="4pm">
                            ...
                            <td>
                                <div class="border-checkbox-group border-checkbox-group-primary">
                                    <input class="border-checkbox" type="checkbox" name="time[]" id="time[]" value="4.20pm">
                            ...
                            <td>
                                <div class="border-checkbox-group border-checkbox-group-primary">
                                    <input class="border-checkbox" type="checkbox" name="time[]" id="time[]" value="4.40pm">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="border-checkbox-group border-checkbox-group-primary">
                                    <input class="border-checkbox" type="checkbox" name="time[]" id="time[]" value="5pm">
                            ...
                            <td>
                                <div class="border-checkbox-group border-checkbox-group-primary">
                                    <input class="border-checkbox" type="checkbox" name="time[]" id="time[]" value="5.20pm">
                            ...
                            <td>
                                <div class="border-checkbox-group border-checkbox-group-primary">
                                    <input class="border-checkbox" type="checkbox" name="time[]" id="time[]" value="5.40pm">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="border-checkbox-group border-checkbox-group-primary">
                                    <input class="border-checkbox" type="checkbox" name="time[]" id="time[]" value="6pm">
                            ...
                            <td>
                                <div class="border-checkbox-group border-checkbox-group-primary">
                                    <input class="border-checkbox" type="checkbox" name="time[]" id="time[]" value="6.20pm">
                            ...
                            <td>
                                <div class="border-checkbox-group border-checkbox-group-primary">
                                    <input class="border-checkbox" type="checkbox" name="time[]" id="time[]" value="6.40pm">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="border-checkbox-group border-checkbox-group-primary">
                                    <input class="border-checkbox" type="checkbox" name="time[]" id="time[]" value="7pm">
                            ...
                            <td>
                                <div class="border-checkbox-group border-checkbox-group-primary">
                                    <input class="border-checkbox" type="checkbox" name="time[]" id="time[]" value="7.20pm">
                            ...
                            <td>
                                <div class="border-checkbox-group border-checkbox-group-primary">
                                    <input class="border-checkbox" type="checkbox" name="time[]" id="time[]" value="7.40pm">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="border-checkbox-group border-checkbox-group-primary">
                                    <input class="border-checkbox" type="checkbox" name="time[]" id="time[]" value="8pm">
                            ...
                            <td>
                                <div class="border-checkbox-group border-checkbox-group-primary">
                                    <input class="border-checkbox" type="checkbox" name="time[]" id="time[]" value="8.20pm">
                            ...
                            <td>
                                <div class="border-checkbox-group border-checkbox-group-primary">
                                    <input class="border-checkbox" type="checkbox" name="time[]" id="time[]" value="8.40pm">
